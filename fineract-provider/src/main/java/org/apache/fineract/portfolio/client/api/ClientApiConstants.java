...
public class ClientApiConstants {
    ...
    //HABILE CHANGES advance search 
    public static final String loanPurposeParamName = "LoanPurpose";

    public static final String datatables = "datatables";
    
    public static final String groupNameParamName = "groupName";
    public static final String highmarkStatusParamName = "highmarkStatus";
    ...
    protected static final Set<String> CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(idParamName,
            ...
            clientNonPersonDetailsParamName, isStaffParamName, groupNameParamName, highmarkStatusParamName));
    ...
    protected static final Set<String> ADVANCE_CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(officeOptionsParamName,
    		staffOptionsParamName,loanPurposeParamName));
