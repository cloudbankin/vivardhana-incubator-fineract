    ...
    public LocalDate generateNextRepaymentDate(final LocalDate lastRepaymentDate, final LoanApplicationTerms loanApplicationTerms,
        ...
        if (isFirstRepayment && firstRepaymentPeriodDate != null) {
            ...
            if (currentCalendar != null) {
                ...
                /*if (loanApplicationTerms.getLoanTermPeriodFrequencyType().equals(PeriodFrequencyType.MONTHS) && reccuringString.equals("FREQ=MONTHLY")) {
                	if(lastRepaymentDate.getMonthOfYear()==2)
                	{
                		dueRepaymentPeriodDate = dueRepaymentPeriodDate.withDayOfMonth(seedDate.getDayOfMonth());
                	}
                }*/
            }
        }
