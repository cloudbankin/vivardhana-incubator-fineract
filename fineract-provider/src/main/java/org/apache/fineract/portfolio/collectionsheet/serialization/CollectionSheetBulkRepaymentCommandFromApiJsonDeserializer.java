...
public final class CollectionSheetBulkRepaymentCommandFromApiJsonDeserializer extends
    ...
    public Map<String, LocalDate> transactionOrRepaymentdate(final JsonCommand command)
    {
    	Map<String,LocalDate> tdate = new HashMap<String,LocalDate>();
    	...
    	final LocalDate repaymentDate = this.fromApiJsonHelper.extractLocalDateNamed("repaymentDate", element);
    	
    	if(transactionDate != null)
    	{
    		tdate.put("transactionDate", transactionDate);
    	}
    	else if(repaymentDate != null)
    	{
    		tdate.put("repaymentDate", repaymentDate);
    	} 	
    ...
    public CollectionSheetBulkRepaymentCommand commandFromApiJson(final String json, final PaymentDetail paymentDetail) {
        ...
        LocalDate repaymentDate = this.fromApiJsonHelper.extractLocalDateNamed("repaymentDate", element);
