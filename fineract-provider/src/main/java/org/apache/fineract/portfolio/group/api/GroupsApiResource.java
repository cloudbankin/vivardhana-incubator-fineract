...
public class GroupsApiResource {
    ...
    public String advanceRetrieveAll(@Context final UriInfo uriInfo, @QueryParam("sqlSearch") final String sqlSearch,
    		...
    		@QueryParam("orderBy") final String orderBy, @QueryParam("sortOrder") final String sortOrder,
    		@QueryParam("displayName") final String displayName,@QueryParam("groupExternalId") final String groupExternalId,
        ...
        final AdvanceSearchParameters advanceSearchParameters = AdvanceSearchParameters.forGroupAdvanceSearch(sqlSearch, displayName, 
        		groupExternalId, officeId, status, loanOfficer, offset, limit, orderBy, sortOrder);
        		
        Page<GroupGeneralData> groups = null;
        
        if (parameters.isPaged()) 
        {
        	groups = this.groupReadPlatformService.advanceRetrievePagedAll(advanceSearchParameters, parameters);
        }
