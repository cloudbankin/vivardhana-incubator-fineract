...
@Service
@CommandType(entity = "BULKREMINDER", action = "SMS")
public class BulkReminderCommandHandler implements NewCommandSourceHandler {

    private final CollectionSheetWritePlatformService collectionSheetWritePlatformService;

    @Autowired
    public BulkReminderCommandHandler(final CollectionSheetWritePlatformService collectionSheetWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.collectionSheetWritePlatformService.smsBulkReminder(command);
    }
