...
public interface CollectionSheetWritePlatformService {
    ...
    CommandProcessingResult smsBulkReminder(JsonCommand command);
    void sampleSms();

	List<BulkReminderData> smsReminderData(String officeId, String centerId, String groupId, String loanOfficerId,
