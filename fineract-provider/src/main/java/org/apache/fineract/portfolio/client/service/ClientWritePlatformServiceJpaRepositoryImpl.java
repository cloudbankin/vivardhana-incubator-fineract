...
import org.apache.fineract.portfolio.client.exception.AadhaarNumberInvalidException;
...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    public CommandProcessingResult createClient(final JsonCommand command) {
        ...
        try {
            ...
            final Date dateofbirth = command.DateValueOfParameterNamed(ClientApiConstants.dateOfBirthParamName);
            ...
            if(dateofbirth!=null)
            {
            	...
            	java.time.LocalDate changedDOB = instant.atZone(defaultZoneId).toLocalDate();*/
            	
            	Date currentdate = new Date();
            	
            	long diffinms = currentdate.getTime() - dateofbirth.getTime();
            	...
            	{
            		throw new ClientAgeInvalidException(dateofbirth);
            	}
            }
            
            //Habile changes for validaying the aadhaar number using VerhoeffAlgorithm
            final String AadhaarNo = command.stringValueOfParameterNamed(ClientApiConstants.externalIdParamName);
            
//            if(AadhaarNo != null)
//            {
//            	boolean result = VerhoeffAlgorithm.validateVerhoeff(AadhaarNo);
//	            if(!result)
//	            {
//	            	throw new AadhaarNumberInvalidException(AadhaarNo);
//	            }
//            }
