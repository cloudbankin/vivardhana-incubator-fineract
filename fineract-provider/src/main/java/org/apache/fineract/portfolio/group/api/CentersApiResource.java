...
public class CentersApiResource {
    ...
    public String advanceRetrieveAll(@Context final UriInfo uriInfo, @QueryParam("sqlSearch") final String sqlSearch,
    		...
    		@QueryParam("orderBy") final String orderBy, @QueryParam("sortOrder") final String sortOrder,
    		@QueryParam("displayName") final String displayName,@QueryParam("centerExternalId") final String centerExternalId,
    		@QueryParam("officeId") final Long officeId, @QueryParam("status") final Long status,
    		@QueryParam("loanOfficer") final Long loanOfficer) {
    	...
    	final AdvanceSearchParameters advanceSearchParameters = AdvanceSearchParameters.forCentersAdvanceSearch(sqlSearch, displayName, centerExternalId,
    			officeId, status, loanOfficer, offset, limit, orderBy, sortOrder);
    	
    	Page<CenterData> centers = null;
    	
    	if (parameters.isPaged())
    	{
            centers = this.centerReadPlatformService.advanceRetrievePagedAll(advanceSearchParameters, parameters);
        }
