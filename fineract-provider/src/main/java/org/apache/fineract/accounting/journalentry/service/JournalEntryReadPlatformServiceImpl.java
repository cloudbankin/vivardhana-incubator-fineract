    ...
    private static final class GLJournalEntryMapper implements RowMapper<JournalEntryData> {
        ...
        public String schema() {
            ...
            sb.append(" journalEntry.id as id, glAccount.classification_enum as classification ,")
                    ...
                    .append("ml.account_no AS LoanId,") //Habile Technology Changes 
            ...
            /**
             * LEFT JOIN m_loan_transaction AS loantrans ON loantrans.id = journalEntry.loan_transaction_id
			   LEFT JOIN m_loan ml on loantrans.loan_id=ml.id
             * 
             */
            sb.append(" from acc_gl_journal_entry as journalEntry ")
                    ...
                    .append(" left join m_loan_transaction as loantrans on loantrans.id = journalEntry.loan_transaction_id")//Habile Technology Changes 
                    .append(" left join m_loan ml on loantrans.loan_id=ml.id")
        ...
        public JournalEntryData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            //Bharath added Habile changes 
            final String LoanId = rs.getString("LoanId");
            ...
            return new JournalEntryData(id, officeId, officeName, glAccountName, glAccountId, glCode, accountType, transactionDate,
                    ...
                    transactionDetailData, currency,LoanId);
        }
    }
