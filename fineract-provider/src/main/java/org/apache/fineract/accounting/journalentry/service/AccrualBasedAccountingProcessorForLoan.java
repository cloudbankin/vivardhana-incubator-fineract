...
public class AccrualBasedAccountingProcessorForLoan implements AccountingProcessorForLoan {
    ...
    public void createJournalEntriesForLoan(final LoanDTO loanDTO) {
        ...
        for (final LoanTransactionDTO loanTransactionDTO : loanDTO.getNewLoanTransactions()) {
            ...
            /** This condition is for hanling the repayment at the time of disbursment 
             *  Added by Bharath Kumar
             */
            /*else if(loanTransactionDTO.getTransactionType().isRepaymentAtDisbursement())
            {
             ...
             ***/
            	...
            	//System.out.println(loanTransactionDTO.getTransactionType().isRepaymentAtDisbursement());
    ...
    private void createJournalEntriesForRepaymentsAndWriteOffs(final LoanDTO loanDTO, final LoanTransactionDTO loanTransactionDTO,
        ...
        for (Entry<GLAccount, BigDecimal> entry : accountMap.entrySet()) {
            ...
            //createCreditJournalEntryOrReversalForLoanCharges
        }
